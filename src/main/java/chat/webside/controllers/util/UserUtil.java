...
public class UserUtil {
    ...
    public void setProfileShow(int userDBId, HttpServletRequest request, UserProfile userProfile, User user, Model model) {
        ...
        model.addAttribute("listOfDefined", userWhichProfileRequested.getCreatedChats());
        model.addAttribute("currentDBUser", user);
        model.addAttribute("listOfChats", userWhichProfileRequested.getChats());
        model.addAttribute("listOfCreatedChats", userWhichProfileRequested.getCreatedChats());
        ...
        List<Chat> unacceptedChallenges = new ArrayList<>();
        requests.forEach((r) -> {
