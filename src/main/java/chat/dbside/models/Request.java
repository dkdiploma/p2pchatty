...
public class Request extends BaseEntity {
    ...
    public List<Chat> getSubjects() {
        return subjects;
    }

    public void setSubjects(List<Chat> subjects) {
    ...
    public void setSubject(Chat chal) {
        subjects = new ArrayList();
        subjects.add(chal);
    }

    public Chat getSubject() {
    ...
    public void removeSubject(Chat chal) {
